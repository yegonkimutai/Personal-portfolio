      ...
      <div className="container contact-container">
        <div className="contact-options">
          <article className="contact-option">
            ...
            <h4>Email</h4>
            <a href="mailto:yegonkimutai.99@gmail.com" target='_blank'>Send a message ✍️</a>
          </article>
          <article className="contact-option">
            <PiTelegramLogoLight className='cont-icon'/>
            <h4>Telegram</h4>
            <a href="https://api.telegram.com/send?phone+254798003353" target='_blank'>Send a message ✍️</a>
          </article>
          <article className="contact-option">
            <BsWhatsapp className='cont-icon'/>
            <h4>WhatsApp</h4>
            <a href="https://api.whatsapp.com/send?phone+254798003353" target='_blank'>Send a message ✍️</a>
          </article>
        </div>
